class ModelObject12_16 {
    ...
    ModelObject12_16(int _ordinal, int _remain) {
        ordinal = _ordinal;
        remain = _remain;
    }
...
class MainModel12_16 {
    ...
    ModelObject12_16 obj1;
    ModelObject12_16 obj2;
    
    ArrayList<RectButton> addButton = new ArrayList<RectButton>();
    ArrayList<RectButton> subButton = new ArrayList<RectButton>();
    
    ModelObject12_16 idle = new ModelObject12_16( -1, 0);
    ModelObject12_16 chosenObj = idle;
    ...
    void setup() {
        ...
        // object 1
        obj1 = new ModelObject12_16(0, 0);
        obj1.setPosition(x, y);
        obj1.setImage(loadImage("../data/img/fish1.png"), imgSize);
        
        // object 2
        obj2 = new ModelObject12_16(1, 0);
        obj2.setPosition(x, y + distance);
        obj2.setImage(loadImage("../data/img/fish2.png"), imgSize);
...
class Question12_16 extends Question {
