class ModelObject12_18 {
    ...
    ModelObject12_18(int _ordinal, int _remain) {
        ordinal = _ordinal;
        remain = _remain;
    }
...
class MainModel12_18 {
    ...
    // all component
    ArrayList<ModelObject12_18> listObj = new ArrayList<ModelObject12_18>();
    ...
    // await
    ModelObject12_18 idle = new ModelObject12_18( -1, 100);
    ModelObject12_18 chosenObj = idle;
    int await = 0;
    ...
    void draw() {
        ...
        for(ModelObject12_18 obj : listObj) {
            obj.draw();
            // if(!state.equals("depart")) {
            //     obj.drawDiff();
        // }
...
class Question12_18 extends Question {
    MainModel12_18 model = new MainModel12_18();
    void setup() {
        super.setup();
