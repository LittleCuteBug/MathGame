class Question12_12 extends Question {
  ...
  int smallBoxLength = bigBoxLength / 6;
  int boxHeight = 50;
  ...
  void setup() {
    super.setup();
    String quizText = "Câu 12_12: Hai bác nông dân có 140 con gà. Số gà của bác nông dân A nhiều gấp 6 lần số gà của bác nông dân B. Hỏi mỗi bác nông dân có bao nhiêu con gà?";
  ...
  void draw() {
	...
	fill(200, 200, 200);
    rect(posXBox + 4 * smallBoxLength,225,smallBoxLength,boxHeight); /// Bignumber box 5
	fill(100, 150, 255);
    rect(posXBox + 5 * smallBoxLength,225,smallBoxLength,boxHeight); /// Bignumber box 6
	fill(140, 255, 50);
