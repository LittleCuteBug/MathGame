class Question12_14 extends Question {
  ...
  void setup() {
    super.setup();
    String quizText = "Câu 12_14: Wilfred, Peter và Bobbie có 60 đô-la. Peter có nhiều hơn Wilfred 5 đô-la. Wilfred có ít hơn Bobbie 4 đô-la. Hỏi mỗi bạn có bao nhiêu đô-la?";
