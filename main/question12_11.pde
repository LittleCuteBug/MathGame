class Question12_11 extends Question {
  ...
  void setup() {
    super.setup();
    String quizText = "Câu 12_11: Sherry và Louisa có 60 viên bi. Số bi của Sherry nhiều gấp 3 lần của Louisa. Hỏi mỗi bạn có bao nhiêu viên bi?";
