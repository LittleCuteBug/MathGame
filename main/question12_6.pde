class ModelObject12_6 {
    ...
    ModelObject12_6(int _ordinal, int _remain) {
        ordinal = _ordinal;
        remain = _remain;
    }
...
class MainModel12_6 {
    ...
    // all component
    ArrayList<ModelObject12_6> listObj = new ArrayList<ModelObject12_6>();
    ...
    // await
    ModelObject12_6 idle = new ModelObject12_6( -1, 100);
    ModelObject12_6 chosenObj = idle;
    int await = 0;
    ...
    void draw() {
        ...
        for(ModelObject12_6 obj : listObj) {
            obj.draw();
            // if(!state.equals("depart")) {
            //     obj.drawDiff();
        // }
...
class Question12_6 extends Question {
    MainModel12_6 model = new MainModel12_6();
    void setup() {
        super.setup();
