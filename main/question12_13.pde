class Question12_13 extends Question {
  ...
  void setup() {
    super.setup();
    String quizText = "Câu 12_13: Có 57 quả táo, lê và đào cùng được đựng trong một chiếc rổ lớn. Đào ít hơn lê 3 quả. Táo nhiều hơn đào 6 quả. Hỏi có bao nhiêu quả đào, bao nhiêu quả táo và bao nhiêu quả lê trong rổ?";
  ...
  void draw() {
    ...
    fill(0);
    text("Số táo là", 300, posYAnswerBoxTitle);
    text(answer[0], 305, posYAnswerBoxText);
    text("Số đào là", 500, posYAnswerBoxTitle);
    text(answer[1], 505, posYAnswerBoxText);
    text("Trả lời", 840, posYAnswerBoxText);
	text("Số lê là", 400, posYAnswerBoxTitle + 100);
