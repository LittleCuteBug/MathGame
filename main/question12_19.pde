class ModelObject12_19 {
    ...
    ModelObject12_19(int _ordinal, int _remain) {
        ordinal = _ordinal;
        remain = _remain;
    }
...
class MainModel12_19 {
    ...
    // all component
    ArrayList<ModelObject12_19> listObj = new ArrayList<ModelObject12_19>();
    ...
    // await
    ModelObject12_19 idle = new ModelObject12_19( -1, 100);
    ModelObject12_19 chosenObj = idle;
    int await = 0;
    ...
    void draw() {
        ...
        for(ModelObject12_19 obj : listObj) {
            obj.draw();
            // if(!state.equals("depart")) {
            //     obj.drawDiff();
        // }
...
class Question12_19 extends Question {
    MainModel12_19 model = new MainModel12_19();
    void setup() {
        super.setup();
        String quizText = "Có 12, 19, 11 con chim sẻ trong 3 chiếc lồng A, B, C. Hỏi Alan cần sắp xếp lại như thế nào để số chim sẻ trong mỗi lồng là như nhau";
